...
describe('AlbumList', () => {
  ...
  const markup2 = `
  <div class="list-item" data-album-id="${data[0].id}">
    <img src="${data2[0].images[2].url}" alt="${data2[0].name}" class="list-image" data-album-id="${data[0].id}">
    <div class="list-description" data-album-id="${data[0].id}">
      <p class="list-title" data-album-id="${data[0].id}">${data2[0].name}</p>
      <p class="list-subtitle" data-album-id="${data[0].id}">${data2[0].artists[0].name}</p>
    </div>
  </div>
  <div class="list-item" data-album-id="${data[0].id}">
    <img src="${data2[1].images[2].url}" alt="${data2[1].name}" class="list-image" data-album-id="${data[0].id}">
    <div class="list-description" data-album-id="${data[0].id}">
      <p class="list-title" data-album-id="${data[0].id}">${data2[1].name}</p>
      <p class="list-subtitle" data-album-id="${data[0].id}">${data2[1].artists[0].name}</p>
    </div>
  </div>`;
